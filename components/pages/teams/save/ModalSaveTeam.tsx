...
import { Button, Input, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Select, Selection, SelectItem, Switch, useDisclosure } from "@nextui-org/react"
          ...
          {(onClose) => (
            <>
              ...
              <form onSubmit={handleSubmit(handleSubmitTeam)} id="saveTeamForm">
                <ModalBody>
                  <label htmlFor="" className="text-gray-800">Nombre del equipo</label>
                  <Input
                  ...
                  />
                  <label htmlFor="" className="text-gray-800">Jefe de equipo</label>
                  <Select
                    items={userData}
                    variant="bordered"
                    size="lg"
                  ...
                  <label htmlFor="" className="text-gray-800">Agregar miembros</label>
                  <Select
                    items={userData}
                    variant="bordered"
                    size="lg"
                  ...
                  <div className="flex items-center justify-between">
                    <label htmlFor="" className="text-gray-800">Equipo Activo</label>
                    <Switch
                      defaultSelected
                      size="sm"
              ...
              <ModalFooter>
                ...
                <Button
                  type="submit"
                  form="saveTeamForm"
                  className="bg-emerald-500 text-white">Crear equipo</Button>
              </ModalFooter>
            </>
          )}
        </ModalContent>
